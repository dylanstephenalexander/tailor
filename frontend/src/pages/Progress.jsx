...
import { ArrowLeft, Home, Search, Dumbbell, User } from 'lucide-react'
...
export default function Progress() {
  ...
  const handleSelectPR = async (pr) => {
    if (selectedPR?.exercise === pr.exercise) {
      setSelectedPR(null)
      setHistory(null)
      return
    }
  ...
  return (
    <div className={styles.page}>
      ...
      <div className={styles.section}>
        ...
        <div className={styles.weightSection}>
          <div className={styles.weightRow}>
            ...
            />
            <button
              className={styles.logWeightButton}
      ...
      {recommendations && (
        <div className={styles.section}>
          <div className={styles.sectionLabel}>Calorie targets</div>
          <div className={styles.trendCard}>
            {[
              ...
              {
                label: 'Weight trend',
                value: recommendations.weight_trend_kg_per_week != null
                  ? `${recommendations.weight_trend_kg_per_week > 0 ? '+' : ''}${recommendations.weight_trend_kg_per_week} kg/week`
                  : 'Need more data'
              },
            ...
            {recommendations.note && (
              <p style={{ fontSize: 12, color: 'var(--muted)', marginTop: 12 }}>{recommendations.note}</p>
            )}
          </div>
        </div>
      )}
      ...
      <div className={styles.section}>
        ...
        {prs.length === 0 ? (
          <div className={styles.emptyState}>No PRs yet — log a workout to get started</div>
        ) : (
